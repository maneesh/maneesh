## Maneesh K Srivastava 👋

I’m **Maneesh Kumar**, an **End-to-End IoT Solution Architect** with **20+ years of experience** building real-world, production-grade technology systems across cloud, IoT, and full-stack platforms.

Over the last **15+ years**, I’ve architected and delivered scalable solutions on **AWS and Azure**, focusing on reliability, security, cost optimization, and enterprise readiness. Alongside architecture, I bring **10+ years of hands-on full-stack development experience**, working across backend systems, APIs, microservices, databases, real-time applications, and modern web interfaces—bridging the gap between system design and execution.
